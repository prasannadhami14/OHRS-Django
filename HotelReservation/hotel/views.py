...
def hotel_rooms(request, hotel_id):
    if request.user.is_authenticated:
            ...
            return render(request, 'room/index.html', {'specific_hotel':specific_hotel,'specific_hotel_rooms': specific_hotel_rooms,'amenities':amenities,'user_count':user_count,'comments':comments,'user_name':user_name,'user_email':user_email})
    else:
